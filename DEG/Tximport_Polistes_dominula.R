########Differential gene expression analysis - Polistes dominula######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Polistes_dominula/quants/")
...
id = c("", "", "", "", "", "") #NEEDS TO BE IN THE ORDER THAT THE FILES ARE READ IN - CHECK 'files'
dex = c("", "", "", "", "", "")
...
p
# ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Polistes_dominula.pdf", width = 7, height = 7) #CHANGE NAME
...
#Save as csv file
# write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Polistes_dominula.csv", row.names = T) #CHANGE NAME
