########Differential gene expression analysis - Acromyrmex echinatior######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Acromyrmex_echinatior/quants/")
...
id = c("SRR7772543", "SRR7772544", "SRR7772545", "SRR7772546", "SRR7772547", "SRR7772548", "SRR7772550", "SRR7772552") #NEEDS TO BE IN THE ORDER THAT THE FILES ARE READ IN - CHECK 'files'
dex = c("worker", "queen", "queen", "worker", "queen", "worker", "worker", "queen")
...
p
ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Acromymrex_echinatior.pdf", width = 7, height = 7) #CHANGE PLOT NAME
...
DEGs$biased_gene <- ifelse(DEGs$log2FoldChange >= 0, "worker", "queen") #Check 'countData"

#Save as csv file
write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Acromymrex_echinatior.csv", row.names = T) #CHANGE PLOT NAME
