########Differential gene expression analysis - Bombus terrestris######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Bombus_terrestris/quants/")
...
head(txi.salmon.g$counts)[,1:6] #Adapt this section of code [,1:Nnumber of individuals being analysed]

# Transcript-level #####EDIT VALUES HERE#####
head(txi.salmon.t$counts)[,1:6] #Adapt this section of code [,1:Nnumber of individuals being analysed]
...
#####EDIT VALUES HERE#####
countData = txi.salmon.g$counts[,1:6]
...
id = c("SRR21115987", "SRR21115988", "SRR21115989", "SRR21116033", "SRR21116041", "SRR21116042")
dex = c("worker", "worker", "worker", "queen", "queen", "queen")
...
p
# ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Bombus_terrestris.pdf", width = 7, height = 7) #CHANGE NAME
...
#Save as csv file
# write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Bombus_terrestris.csv", row.names = T)
