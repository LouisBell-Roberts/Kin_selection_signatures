########Differential gene expression analysis - Ooceraea biroi######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Ooceraea_biroi/quants/")
...
id = c("SRR7204406", "SRR7204407", "SRR7204408", "SRR7204409", "SRR7204410", "SRR7204411", "SRR7204412", "SRR7204413") #NEEDS TO BE IN THE ORDER THAT THE FILES ARE READ IN - CHECK 'files'
dex = c("queen", "queen", "queen", "queen", "worker", "worker", "worker", "worker")
...
p
ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Ooceraea_biroi.pdf", width = 7, height = 7) #CHANGE NAME
...
#Save as csv file
write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Ooceraea_biroi.csv", row.names = T) #CHANGE NAME
