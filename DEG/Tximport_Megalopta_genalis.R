########Differential gene expression analysis - Megalopta genalis######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Megalopta_genalis/quants/")
...
id = c("SRR3948549", "SRR3948551", "SRR3948559", "SRR3948569", "SRR3948571", "SRR3948576", "SRR3948580", "SRR3948582") #NEEDS TO BE IN THE ORDER THAT THE FILES ARE READ IN - CHECK 'files'
dex = c("worker", "worker", "queen", "worker", "queen", "queen", "queen", "worker")
...
p
ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Megalopta_genalis.pdf", width = 7, height = 7) #CHANGE NAME
...
#Save as csv file
write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Megalopta_genalis.csv", row.names = T) #CHANGE NAME
