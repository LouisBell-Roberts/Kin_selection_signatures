########Differential gene expression analysis - Harpegnathos saltator######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Harpegnathos_saltator/quants/")
...
id = c("SRR5909301", "SRR5909302", "SRR5909303", "SRR5909319", "SRR5909320", "SRR5909321") #NEEDS TO BE IN THE ORDER THAT THE FILES ARE READ IN - CHECK 'files'
dex = c("queen", "queen", "queen", "worker", "worker", "worker")
...
p
ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Harpegnathos_saltator.pdf", width = 7, height = 7) #CHANGE NAME
...
#Save as csv file
write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Harpegnathos_saltator.csv", row.names = T) #CHANGE NAME
