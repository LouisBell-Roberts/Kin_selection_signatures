########Differential gene expression analysis - Formica exsecta######
...
setwd("/Volumes/Pop_Gen/Differential_gene_expression/Species/Formica_exsecta/quants/")
...
head(txi.salmon.g$counts)[,1:8] #Adapt this section of code [,1:Nnumber of individuals being analysed]

# Transcript-level #####EDIT VALUES HERE#####
head(txi.salmon.t$counts)[,1:8] #Adapt this section of code [,1:Nnumber of individuals being analysed]
...
#####EDIT VALUES HERE#####
countData = txi.salmon.g$counts[,1:8]
...
id = c("DRR118162", "DRR118163", "DRR118166", "DRR118167", "DRR118170", "DRR118171", "DRR118174", "DRR118175")
dex = c("queen", "queen", "worker", "worker", "queen", "queen", "worker", "worker")
...
p
# ggsave(plot = p, filename = "/Volumes/Pop_Gen/Differential_gene_expression/DGE_volcano_plots/Formica_exsecta.pdf", width = 7, height = 7) #CHANGE NAME
...
DEGs <- dplyr::filter(topT, (abs(log2FoldChange) > 1), padj <0.05) #166 genes
...
#Save as csv file
# write.csv(DEGs, "/Volumes/Pop_Gen/Differential_gene_expression/DGE_csv_outputs/Formica_exsecta.csv", row.names = T)
